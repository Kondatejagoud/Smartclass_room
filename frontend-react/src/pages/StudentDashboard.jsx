...
function StudentDashboard() {
  ...
  const joinClassroom = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setupWebSocket();
        setupVideo();
        setParticipants([{ id: 'teacher', name: 'Teacher', role: 'teacher', muted: false }]);
      } else {
  ...
  const setupWebSocket = () => {
    ...
    wsRef.current.onmessage = async (e) => {
      ...
      else if (data.type === 'webrtc_offer')   await handleWebRTCOffer(data.offer);
  ...
  const sendChat = () => {
    ...
    setChatMessages(prev => [...prev, { sender: localStorage.getItem('username'), text: chatInput, time: new Date().toLocaleTimeString(), self: true }]);
    setChatInput('');
  };
  ...
  const leaveClassroom = () => {
    ...
    setJoined(false); setClassId(''); setClassName('');
    setWarningCount(0); setFocusScore(100);
            ...
            <div className="sc-video-area">
              <div className="sc-video-grid">
                ...
                <div className="sc-tile sc-tile-teacher">
                  ...
                  <div className="sc-tile-bar">
                    <span className="sc-tile-name"><i className="fas fa-star"></i> Teacher (Host)</span>
                ...
                <div className="sc-tile sc-tile-self">
                  {isCameraOff
                    ? <div className="sc-tile-avatar"><i className="fas fa-user-graduate"></i></div>
              ...
              <div className="sc-controls">
                ...
                <div className="sc-controls-center">
                  ...
                  <button className={`sc-ctrl-btn ${isCameraOff ? 'sc-ctrl-active' : ''}`} onClick={toggleCamera}>
                ...
                <div className="sc-panel-body">
                  ...
                  <div className="sc-participant-item sc-participant-teacher">
                    ...
                    <div className="sc-participant-info">
                      <span className="sc-participant-name">Teacher</span>
